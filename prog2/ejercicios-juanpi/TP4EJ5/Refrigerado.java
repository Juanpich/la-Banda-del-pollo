...
public class Refrigerado extends Producto {
	...
	public Refrigerado(String fechaVencimineto, int nroLote, String fechaEnvasado, String granjaOrigen, int codigoOSA,
			double temperatura) {
	...
	public String getInfoCompleta() {
		return "Este producto refrigerado" + super.getInfoCompleta() + "El producto fue revisado por la OSA con el codigo:" + this.getCodigoOSA() + 
